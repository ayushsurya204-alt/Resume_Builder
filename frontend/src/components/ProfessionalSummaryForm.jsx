...
const ProfessionalSummaryForm = ({data,onChange,setResumeData}) => {
  ...
  const generateSummary = async () => {
    try {
      ...
      const response = await api.post('/api/ai/enhance-pro-sum',{userContent:propmt},{headers:{Authorization: token}})
  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='mt-6'>
          ...
          {7} className='w-full px-3 py-4 mt-2 border text-sm border-gray-300
