  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'> 
           ...
           className='flex-1 px-3 py-2 text-sm' onChange=
           {(e)=>setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress}
            />
            <button onClick={addSkill} disabled={!newSkill.trim} className='flex items-center
            gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg 
        ...
        <div className='bg-blue-50 p-3 rounded-lg '>
            ...
            Add 8-12 relevant skills. Include both technical skills (programming languages,
