...
const Dashboard = () => {
 ...
 const colors =  ["#9333ea","#d97706","#dc2826","#0284c7","#16a34a"]
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        <p className='text-2xl font-medium mb-6 gradient-to-r from-slate-600 to bg-slate-700
        bg-clip-text text-transparent sm:hidden'>Welcome,Ayush Surya</p>

       <div className='flex gap-4'>
        <button onClick={()=>setShowCreateResume(true)} className='w-full bg-white sm:max-w-36 flex flex-col items-center
        ...
        <button onClick={()=>setShowUploadResume(true)} className='w-full bg-white sm:max-w-36 flex flex-col items-center
        justify-center rounded-lg gap-2 text-slate-600 border border-dashed
     ...
     <div className='grid grid-cols-2 sm:flex flex-wrap gap-4'>
        {allResumes.map((resume,idx)=>{
          ...
          return(
            <button key={idx} onClick={()=> navigate(`/app/builder/${resume._id}`)} className='relative  w-full sm:max-w-36 h-48 flex
          ...
          borderColor:baseColor + '40'}}>
            ...
            <p className='text-sm group-hover:scale-105 transistion-all px-2
            ...
            <div onClick={e=> e.stopPropagation()} className='absolute top-1 right-1 group-hover:flex itmes-center hidden'>
            ...
            px-4 py-2 mb-4 focus:border-green-600 ring-green-600' required />
              ...
              <div>
                ...
                text-slate-700'>
                  ...
                  border group text-slate-400 border-dashed rounded-md
                  p-4 py-10 my-10 hover:border-green-500
