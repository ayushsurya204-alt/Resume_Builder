...
import { ArrowLeftIcon, Briefcase, BriefcaseBusiness, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, Globe, GraduationCap, Linkedin, Mail, MapPin, Phone, Share2Icon, Sparkles, User } from 'lucide-react'
             ...
             border-gray-300 py-1'>
              ...
              <div className='flex items-center'>
                {activeSectionIndex !== 0 && (
                  ...
                  Math.max(prevIndex - 1,0))} className='flex items-center gap-1 p-3 rounded-lg
                  ...
                  <button onClick={()=>setActiveSectionIndex((prevIndex)=>
                  Math.min(prevIndex + 1, sections.length - 1))} className={`flex 
           ...
           <div className='space-y-6'>
             {activeSection.id=== 'personal' && (
              <PersonalInfoForm data={resumeData.personal_info} onChange={(data)=>
                setResumeData(prev => ({...prev,personal_info:
